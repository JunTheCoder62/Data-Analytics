...
st.header('1. Bagaimana tren pertumbuhan penggunaan bike sharing menunjukkan pertumbuhan yang konsisten dari Februari hingga September 2012? Berapa total growth rate dan apakah setiap bulan menunjukkan peningkatan month-over-month ?')
...
st.header('2. Bagaimana Perbedaan signifikan dalam rata-rata jumlah bike rental antara hari kerja dan hari libur/weekend ?. Seberapa besar perbedaan tersebut dan apakah pola ini konsisten di seluruh musim selama 2 tahun terakhir (Januari 2011 - Desember 2012)?')
